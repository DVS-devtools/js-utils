...
const _fetch = global.fetch; // eslint-disable-line no-underscore-dangle
...
describe('Fetcher.normalizeURL', () => {
    ...
    it('should call the isAbsoluteUrl', () => {
        const _isAbsoluteUrl = utils.isAbsoluteUrl; // eslint-disable-line no-underscore-dangle
...
describe('Fetcher.refreshToken', () => {
    ...
    it('should delete the Authorization header if the tokenGenerator throws an error', async () => {
        global.fetch = jest.fn().mockImplementation(() => Promise.reject('error')); // eslint-disable-line prefer-promise-reject-errors
...
describe('Fetcher calls', () => {
    ...
    beforeEach(() => {
        global.fetch = jest.fn().mockImplementation((u, params) => (
            Promise.resolve({
                json() {
                    return { url: u, params };
                }
    ...
    it('should call performFetch', () => {
        const _performFetch = FC.performFetch; // eslint-disable-line no-underscore-dangle
